...
export default function Profil (props) {
    const styeObject={color:"rgb(91, 28, 110)", paddingTop:"10px", fontSize:"40px"}
    ...
    return (
        ...
        <p style={styeObject1}>
            ...
            J'ai pris mon diplôme de l'école nationale des ingénieurs de sfax avec une mention "trés bien". 
       </p>
        </div>
